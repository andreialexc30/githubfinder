...
})({"enkrF":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4e5dac8afe405db7";
module.bundle.HMR_BUNDLE_ID = "1331515332acab48";
"use strict";
...
const FINDER = function() {
    ...
    submitBtn.addEventListener('click', (e)=>{
        ...
        if (input === '' || input === null) return invalidInput();
        // Github API
        ...
        fetch(endpoint).then((response)=>{
            if (response.status !== 200) return httpStatus(response);
    ...
    // remove warning
    function goAway(main1, child) {
        setTimeout(()=>{
            main1.removeChild(child);
        }, 5000);
    }
...
//# sourceMappingURL=index.32acab48.js.map
